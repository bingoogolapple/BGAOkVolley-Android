...
public class MainActivity extends AppCompatActivity {
    ...
    public void testGsonResponseNormal(View v) {
        ApiClient.testGsonResponseNormal(this, new VolleyResponseListener.VolleyResponseDelegate<Normal>() {
            @Override
            public void onSucess(Normal content) {
                ToastUtil.show("请求成功");
            }
    ...
    public void testGsonResponseNest(View v) {
        ApiClient.testGsonResponseNest(this, new VolleyResponseListener.VolleyResponseDelegate<Nest>() {
            @Override
            public void onSucess(Nest content) {
                ToastUtil.show("请求成功");
            }
    ...
    public void testGsonResponseList(View v) {
        ApiClient.testGsonResponseList(this, new VolleyResponseListener.VolleyResponseDelegate<ArrayList<Normal>>() {
            @Override
            public void onSucess(ArrayList<Normal> content) {
                ToastUtil.show("请求成功");
            }
